<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    {{-- <div class="w-10 h-10 sm:bg-blue-300 md:bg-green-300 lg:bg-red-300 xl:bg-black-300"></div> --}}
        ...
        <div class="flex flex-wrap -mx-3 mb-6 my-4">
            ...
            <p class="w-full px-3 mb-6">
                ...
                <input type="text" name="slug" wire:model="plan.slug"
                       class="block appearance-none w-full bg-gray-200 border @error('slug') border-red-500 @else border-gray-200 @enderror  text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
